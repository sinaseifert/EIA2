...
(function (L09_Canvas) {
    ...
    function callfunction() {
        ...
        for (let i = 0; i < 50; i++) {
            let _x = 700;
            let _radius = Math.random() * 10;
            let _y = Math.random() * 700;
            if (i < Math.random() * 50) {
                _x = 200;
            }
    ...
    //Schatztruhe
    function drawchest(_x, _y, _width, _height) {
        //Deckel
        crc2.beginPath();
